...
/** Contains classes representing network measurements, such as those gathered
  ...
  * [[nz.net.wand.amp.analyser.flink.InfluxSubscriptionSourceFunction InfluxSubscriptionSourceFunction]].
  ...
  * [[nz.net.wand.amp.analyser.measurements.Measurement Measurement]]
  * represent the basic measurement, complete with its stream ID. They contain
  * no metadata, but can be "enriched" using
  * [[nz.net.wand.amp.analyser.measurements.MeasurementFactory.enrichMeasurement MeasurementFactory.enrichMeasurement]].
  ...
  *
  * - Classes which inherit from
  * [[nz.net.wand.amp.analyser.measurements.RichMeasurement RichMeasurement]]
  ...
  *
  * Use the [[nz.net.wand.amp.analyser.flink.LatencyTSAmpFileInputFormat LatencyTSAmpFileInputFormat]]
  * and [[nz.net.wand.amp.analyser.flink.LatencyTSSmokepingFileInputFormat LatencyTSSmokepingFileInputFormat]]
