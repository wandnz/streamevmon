...
class MeasurementFromSubscription extends FlatSpec {
  "ICMP.create" should "convert an entry from a subscription into an ICMP object" in {
  ...
  "DNS.create" should "convert an entry from a subscription into a DNS object" in {
  ...
  "Traceroute.create" should "convert an entry from a subscription into a Traceroute object" in {
  ...
  "MeasurementFactory.createMeasurement" should "convert several entries to their respective Measurement subclasses" in {
    Seq(
